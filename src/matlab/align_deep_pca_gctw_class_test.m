function align_deep_pca_gctw_class_test(inputFolder, class, testSample, outputFolder, ctwFolder , l)
% TODO desc
%
% History
...
disp([' config : ' , inputFolder,  ' ' , class, ' ',testSample, ' ',   outputFolder,' ', ctwFolder ,' ', l ]);
